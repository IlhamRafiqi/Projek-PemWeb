...
<body class="bg-[#f0f7ef] text-green-900 font-sans pt-16">
    <script>
    ...
    <section class="flex flex-col md:flex-row items-center justify-center px-8 py-16 gap-16">
        <div class="flex items-center justify-center overflow-hidden" data-aos="fade-right" data-aos-delay="100">
            <img src="/images/LogoSalman.png" alt="Logo Salman" class="object-contain w-[340px] h-[340px]" />
        </div>
        <div class="max-w-md min-w-[380px]" data-aos="fade-left" data-aos-delay="200">
            ...
            <a href="/kontak" class="inline-flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-8 rounded-full shadow-md text-lg transition hover:scale-105 transform duration-300" data-aos="zoom-in" data-aos-delay="300">
                Kontak Kami
    ...
    <section class="bg-white py-14">
        <h3 class="text-center text-2xl font-extrabold mb-14 text-green-800" style="letter-spacing:-1px;" data-aos="fade-up">Layanan Kami</h3>
        <div class="flex justify-center gap-4 px-4 flex-wrap">
            <!-- Card 1 -->
            <a href="/inventaris-guest" class="block" data-aos="fade-up" data-aos-delay="100">
                <div class="border-4 border-green-400 rounded-2xl bg-[#ecf6ec] p-5 w-60 flex flex-col justify-center transition-all duration-300 hover:shadow-lg hover:scale-105 hover:border-green-500">
            ...
            <!-- Card 2 -->
            <a href="/tentang" class="block" data-aos="fade-up" data-aos-delay="200">
                <div class="border-4 border-green-400 rounded-2xl bg-[#ecf6ec] p-5 w-60 flex flex-col justify-center transition-all duration-300 hover:shadow-lg hover:scale-105 hover:border-green-500">
                    <div class="flex items-start gap-3">
                        <span class="mt-1">
            ...
            <!-- Card 3 -->
            <a href="/kontak" class="block" data-aos="fade-up" data-aos-delay="300">
                <div class="border-4 border-green-400 rounded-2xl bg-[#ecf6ec] p-5 w-60 flex flex-col justify-center transition-all duration-300 hover:shadow-lg hover:scale-105 hover:border-green-500">
                    <div class="flex items-start gap-3">
                        <span class="mt-1">
